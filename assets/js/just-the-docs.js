(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://abelfodil.github.io/knawledge/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://abelfodil.github.io/knawledge/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://abelfodil.github.io/knawledge/assets/css/just-the-docs-' + theme + ".css"
      );
    };
